...
P_InErrMap.CoderInfo.StorageClass =  'Custom';
P_InErrMap.CoderInfo.Alias = char([]);
P_InErrMap.CoderInfo.CustomStorageClass =  'Const';
P_InErrMap.Description = char([]);
P_InErrMap.DataType =  'auto';
P_InErrMap.Min = double(-100);
P_InErrMap.Max = double(100);
...
P_OutMap.CoderInfo.StorageClass =  'Custom';
P_OutMap.CoderInfo.Alias = char([]);
P_OutMap.CoderInfo.CustomStorageClass =  'Const';
P_OutMap.Description = char([]);
P_OutMap.DataType =  'auto';
P_OutMap.Min = double(-100);
P_OutMap.Max = double(100);
