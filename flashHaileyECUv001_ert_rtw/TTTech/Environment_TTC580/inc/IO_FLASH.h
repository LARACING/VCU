...
/**********************************************************************************************//**
 *
 * \brief Blocks (or unblocks) the API access to the external flash
 *
 ...
 *   The function \c IO_FLASH_SetBusy() allows internal blocking of the API functions to ensure
 *   that they cannot interfere with the direct read access.
 *
 * \note
 *   The blocking applies to the following API functions: 
 *   \c IO_FLASH_BlockErase(), \c IO_FLASH_ChipErase(), \c IO_FLASH_Read(), and \c IO_FLASH_Write().
 *   Switching flash banks is not blocked.
 *
 * \param  busy             #TRUE = flash API use blocked, #FALSE = flash API use allowed
 *
 * \return #IO_ErrorType
 ...
 *
 *************************************************************************************************/
IO_ErrorType IO_FLASH_SetBusy(bool busy);
