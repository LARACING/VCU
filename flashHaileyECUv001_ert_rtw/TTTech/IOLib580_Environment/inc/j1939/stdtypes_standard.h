...
* 03/31/15     LMO (TTControl) include renamed according to changes in data types
*
*****************************************************************************/
...
typedef   long            S32;  /* signed   32-bit data type */
 ...
 */
	...
	typedef unsigned char      HUGE_U8;     
	typedef char               HUGE_S8;
#endif
