 ...
 *
 * \remarks Upon reset the device will boot into safe state and the IO_Driver_Init will return
 *          an error. The intended use of this function is to activate the bootloader from an
 *          application.
 *
 * \return #IO_ErrorType
 * \retval #IO_E_OK                         everything fine
