 ...
 *  sensor connected to one of the sensor supplies is mainly limited by the fact that the related stages are
 *  designed for input voltages up to 32V or 55V, therefore the precision of those inputs is only slightly
 *  improved by selecting the ratiometric mode. <B>The configuration options not listed above are NOT
 *  recommended</B>.
 *
 *  ADC-API Usage:
