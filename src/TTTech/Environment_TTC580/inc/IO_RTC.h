 ...
 *   from within a callback, the function \c IO_RTC_Process() can be called instead of
 *   \c IO_RTC_GetDateAndTimeStatus() in order to check for completeness and trigger the RTC
 *   processing.
 *
 *   \n
 *   RTC-API Usage:
 *     - \ref rtc_examples "Examples for RTC API functions"
 *
...
/**********************************************************************************************//**
 *
 * \brief Triggers the internal processing and gets status of RTC device.
 *
 * \return #IO_ErrorType
 * \retval #IO_E_OK                          everything fine
 ...
 * \retval #IO_E_CHANNEL_NOT_CONFIGURED      the module has not been initialized
 * \retval #IO_E_INTERNAL_CSM                An internal error has occured in processing the RTC request.
 * \retval #IO_E_UNKNOWN                      An error occurred converting the data from the RTC chip
 *
 *************************************************************************************************/
IO_ErrorType IO_RTC_Process(void);
...
/**********************************************************************************************//**
 *
 * \brief Gets the status of the external RTC device
 *
 * \return #IO_ErrorType
 * \retval #IO_E_OK                          everything fine
 * \retval #IO_E_BUSY                        a get or set transfer is still ongoing, wait to be
