...
START_DIR    = C:/Users/Jacob/Documents/MATLAB
#MODELREFS    = 
#Other possible defines = -DMODEL=flashHaileyECUv001 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
NUM_SAMPLE_TIMES = 1
...
#tmf begin
ADD_INCLUDES =  -I"$(START_DIR)"  -I"$(START_DIR)/flashHaileyECUv001_ert_rtw"  -I"$(MATLAB_ROOT)/extern/include"  -I"$(MATLAB_ROOT)/simulink/include"  -I"$(MATLAB_ROOT)/rtw/c/src"  -I"$(MATLAB_ROOT)/rtw/c/src/ext_mode/common"  -I"$(MATLAB_ROOT)/rtw/c/ert" 
...
ifneq ("$(NUM_SAMPLE_TIMES)","1")
	@echo - 
	@echo NOTE: The model flashHaileyECUv001 contains more than one sample time.
